...
const Testimonial=(props)=>{
    ...
    function supriseHandler(){
           let var1=Math.floor((Math.random()*reviews.length));
           setIndex(var1);
    }
    ...
    return(
     ...
     <Card review={reviews[index]}></Card>{/*check that is this working for one tag only*/}

     <div 
      className="flex  text-3xl mx-auto mt-5 gap-3 text-violet-400 font-bold  ">
                <button
